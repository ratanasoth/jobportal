...
<head>
    <meta charset="utf-8">
    <title>Job Seeker Section</title>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12" style="padding-left:0">
               <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p><a href="{{url('/seeker')}}">{{trans("labels.my_profile")}}</a></p>
                            <p><a href="{{url('/seeker/cv')}}">{{trans("labels.my_resume")}}</a></p>
                            <p><a href="{{url('/seeker/document')}}">{{trans("labels.my_document")}}</a></p>
                            <p><a href="{{url('/seeker/reset-password')}}">{{trans("labels.change_password")}}</a></p>
                            <p><a href="{{url('/seeker/logout')}}">{{trans("labels.logout")}}</a></p>
                        </div>
                </div>
            </div>
