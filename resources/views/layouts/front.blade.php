            ...
            <div class="navbar-header">
                ...
                <?php
                    ...
                    $logo = DB::table('logos')
                        ...
                        ->first();
                ?>
                <a class="navbar-brand" href="{{url('/')}}"><img class="logo" src="{{asset('img/'.$logo->photo)}}" alt="logo"></a>
            </div>
            <!-- Navigation -->
                ...
                <ul class="nav navbar-nav menu-right">
                    ...
                    <li>
                        <div class="dropdown dropdown-custom">
                            <button class="btn btn-warning border-radius-none dropdown-toggle" type="button" data-toggle="dropdown"> {{session('seeker')->username}}
                            <span class="caret"></span></button>
                            <ul class="dropdown-menu border-radius-none">
                                <li><a href="{{url('/seeker')}}">{{trans("labels.my_profile")}}</a></li>
                                <li><a href="{{url('/seeker/cv')}}">{{trans("labels.my_resume")}}</a></li>
                                <li><a href="{{url('/seeker')}}">{{trans("labels.change_password")}}</a></li>
                                <li><a href="{{url('/seeker/logout')}}">{{trans("labels.logout")}}</a></li>
                            </ul>
                        </div>
                    </li>
                    @else
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <span class="caret"></span></button>
                            <ul class="dropdown-menu border-radius-none">
                                <li><a href="{{url('/employer')}}">{{trans("labels.my_profile")}}</a></li>
                                <li><a href="{{url('/employer/job')}}">{{trans("labels.my_job")}}</a></li>
                                <li><a href="{{url('/employer/company')}}">{{trans("labels.my_company")}}</a></li>
                                <li><a href="{{url('/employer/subscription')}}">{{trans("labels.my_subscription")}}</a></li>
                                <li><a href="{{url('/employer/search/cv')}}">{{trans("labels.find_cv")}}</a></li>
                                <li><a href="{{url('/employer/reset-password')}}">{{trans("labels.change_password")}}</a></li>
                    ...
                    <li>
                        <div class="dropdown">
                            <button class="btn btn-success border-radius-none dropdown-toggle" type="button" data-toggle="dropdown"> {{trans("labels.employer")}}
                            <span class="caret"></span></button>
                            <ul class="dropdown-menu border-radius-none">
                                <li><a href="{{url('/employer/login')}}">{{trans("labels.login")}}</a></li>
                                <li><a href="{{url('/employer/register')}}">{{trans("labels.register")}}</a></li>
                            </ul>
                        </div>
                    </li>
                    @endif
                        ...
                        <div class="col-xs-8 col-xs-offset-2">
                            <form action="{{url('/job/search')}}" method="get">
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-warning border-radius-none btnj" type="submit">{{trans("labels.search")}}</button>
                                </span>
                                </div>
                            </form>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="footer_item">
                    ...
                    <!-- <p class="text-primary">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem</p><br> -->
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="footer_item">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{url('/page/5')}}">{{trans("labels.faq")}}</a></li>
