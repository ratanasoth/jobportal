            ...
            <form action="{{url('/employer/job/save')}}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <textarea name="requirement" id="requirement" cols="30" rows="10">{{old('requirement')}}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <button class="btn btn-warning border-radius-none" type="reset">{{trans('labels.cancel')}}</button>
                    </div>
                </div>
            </form>
        </div>
