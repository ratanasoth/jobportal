    ...
    <div class="panel-body">
        ...
        <form name="frm" action="{{url('/employer/update')}}" method="post" class="from-horizontal" onsubmit="return confirm('You want to save changes?')">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group row">
                        <label for="phone" class="control-label col-sm-5">{{trans('labels.phone')}} <span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <a href="{{url('/employer')}}" class="btn btn-danger border-radius-none">{{trans('labels.cancel')}}</a>
                        </div>
                    </div>
                </div>
            </div>
