                    ...
                    <div class="col-md-7">
                        <div class="panel panel-default border-radius-none">
                            <div class="panel-heading">
                                <h3 class="panel-title orange">{{trans("labels.employer_registration_form")}}</h3>
                            </div>
                            <div class="panel-body">
                                <form action="{{url('/employer/save')}}" method="post" accept-charset="UTF-8" role="form" onsubmit="return matching()">
                                    {{csrf_field()}}
                                    @if(Session::has('sms1'))
                                    <div class="row">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        <label for="phone" class="control-label col-sm-3">{{trans("labels.phone")}}<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
