...
@section('content')
    <div class="panel-heading">
        <span class="orange bold"><span class="orange">{{trans('labels.edit_job')}}</span></span>
            ...
            <form action="{{url('/employer/job/update')}}" method="post">
                    ...
                    <div class="col-sm-8">
                        ...
                        <select name="type" id="type" class="form-control">
                            @foreach($job_types as $type)
                                <option value="{{$type->name}}" {{$job->job_type==$type->name?'selected':''}}>{{$type->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <textarea name="requirement" id="requirement" cols="30" rows="10">{{$job->requirement}}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-8">
