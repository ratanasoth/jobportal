...
@section('content')
    ...
    <div class="panel-heading">
        <span class="orange bold"><span class="orange">{{trans('labels.manage_my_resume')}}</span></span>
    </div>
    <div class="panel-body">
        <div class="applications-content">
            @if($cv==NULL)
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p class="text-center">
                            <a href="{{url('/seeker/create/cv')}}" class="btn btn-warning border-radius-none">{{trans('labels.create_new_resume')}}</a>
                        </p>
                    </div>
                </div>
            @else
            ...
            <div class="row">
                <div class="col-sm-12">
                    <br>
                    <a href="{{url('/seeker/edit_cv/'.$cv->id)}}" class="btn btn-warning border-radius-none">{{trans('labels.update_cv')}}</a>
                </div>
            </div>
        @endif
        </div>
