                    ...
                    <div class="col-md-6">
                          <div class="panel panel-default border-radius-none">
                                            <div class="panel-heading">
                                                <h3 class="panel-title orange">{{trans("labels.seeker_login")}}</h3>
                                            </div>
                                            <div class="panel-body">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <p>{{trans('labels.dont_have_account')}} <a href="{{url('/seeker/register')}}">&nbsp;{{trans('labels.create_new_account')}}</a></p>
                                                        <p>
