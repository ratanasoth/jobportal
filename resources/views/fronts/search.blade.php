            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-9">
                        <div class="panel-body panel-body-costum">
                            <div id="trapezoid">
                                <div class="label-by-category bold orange">{{trans('labels.search_result')}}</div>
                            </div><br>
                            @if(count($jobs)<=0)
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <br>
                                        <strong class="text-success">There is no job found!</strong>
                                    </div>
                                </div>
                            @endif
                            @foreach($jobs as $job)
                                    ...
                                    <div class="col-sm-12">
                                        <p class="job-title new-job">
                                            ...
                                            @if($job->create_at>=date('Y-m-d', strtotime(date('Y-m-d') . '- 7 day')))
                                                <img src="{{asset('img/new.jpg')}}" alt="" style="width: 36px">
                                            @endif
                                        </p>
