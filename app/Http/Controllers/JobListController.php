   ...
   // index
    ...
    public function detail($id)
    {
        ...
        $data['job'] = DB::table("jobs")
            ...
            ->where("jobs.id", $id)
            ->select("jobs.*", "employers.first_name", "employers.last_name", "employers.email", "employers.phone", "companies.name as cname", "categories.name as catname", "companies.address")
            ->first();
